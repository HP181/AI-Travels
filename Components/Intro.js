...
import { CalendarIcon, MapPinIcon, PlaneLandingIcon, PlaneTakeoffIcon, SearchIcon, UsersIcon } from 'lucide-react'
    ...
    <div className="container mx-auto relative z-10 py-24 md:py-16 flex flex-col justify-center items-center">
      <div className="max-w-4xl space-y-4 mx-auto  text-white">
        ...
        <p className="text-lg md:text-xl p-2 md:p-0">
          Plan your perfect trip with our expert recommendations, curated itineraries, and exclusive deals.
        </p>
      </div>
      <div className="mt-8 max-w-4xl bg-white rounded-lg shadow-lg p-1  pt-3 sm:p-5 md:p-5">
        <Tabs defaultValue="flights" className="w-full">
          <TabsList className="grid w-full grid-cols-4 space-x-2 h-12">
            <TabsTrigger value="flights" className="flex items-center gap-2 hover:cursor-pointer">
              <PlaneTakeoffIcon className="h-4 w-4" />
              <span className='text-xs md:text-base'>Flights</span>
            </TabsTrigger>
            <TabsTrigger value="hotels" className="flex items-center gap-2 hover:cursor-pointer">
              <MapPinIcon className="h-4 w-4" />
              <span className='text-xs md:text-base'>Hotels</span>
            </TabsTrigger>
            <TabsTrigger value="packages" className="flex items-center gap-2 hover:cursor-pointer">
              <PlaneLandingIcon className="h-2 w-2" />
              <span className='text-[10px] md:text-base'>Packages</span>
            </TabsTrigger>
            <TabsTrigger value="activities" className="flex items-center gap-2 hover:cursor-pointer">
          ...
          <TabsContent value="flights" className="mt-4 p-2">
            <div className="grid gap-4 md:grid-cols-4">
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-black">Dates</label>
        ...
        <PopoverContent className="w-auto p-0" align="start">
          ...
          />
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-black">Travelers</label>
                {/* <div className="flex items-center border rounded-md px-3 py-2"> */}
                  {/* <UsersIcon className="h-4 w-4 text-muted-foreground mr-2" /> */}
                  <Input className="text-sm text-muted-foreground" type="number" min="1" placeholder="1 Adult" />
                  {/* <span className="text-sm text-muted-foreground">1 Adult</span> */}
                {/* </div> */}
              </div>
            </div>
            <Button className="mt-4 w-full md:w-auto hover:cursor-pointer" size="lg">
          ...
          <TabsContent value="hotels" className="mt-4 p-2">
            <div className="grid gap-4 md:grid-cols-4">
              <div className="space-y-2 md:col-span-2">
                ...
                <Input placeholder="City, region, or property" type="text"/>
              </div>
              <div className="space-y-2">
                <label className="text-sm font-medium text-black">Dates</label>
                {/* <div className="flex items-center border rounded-md px-3 py-2"> */}
        ...
        <PopoverContent className="w-auto p-0" align="start">
          ...
          />
              ...
              <div className="space-y-2">
                ...
                {/* <div className="flex items-center border rounded-md px-3 py-2"> */}
                  {/* <UsersIcon className="h-4 w-4 text-muted-foreground mr-2" /> */}
                <Input placeholder="2 Guests" type="number" min="1"/>
          ...
          <TabsContent value="packages" className="mt-4 p-2">
            <div className="grid gap-4 md:grid-cols-3">
              <div className="space-y-2">
                ...
                <Input placeholder="Departure city" type="text"/>
              </div>
              <div className="space-y-2">
